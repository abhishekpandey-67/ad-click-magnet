    ...
    return(
        <div className="team-sec-container flex items-center justify-between w-full">
            <div className="team-sec-content">
                ...
                <p className="team-sec-para">At Numerique, we’re focused on building strong and lasting client partnerships. By drawing on our deep industry knowledge and expertise, we provide the insights you need to build and evolve your brand, drive business performance and mitigate risk.</p>
